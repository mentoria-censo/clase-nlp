...
**Vectorización en base a frecuencias** [y Word embeddings]{.lightgray}
...
## Paréntesis: preprocesamiento de texto
...
[Vectorización en base a frecuencias y]{.lightgray} **Word embeddings**
...
- Para _word embeddings_ veremos su implementación en Python, ya que es donde
